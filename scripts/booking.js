$(document).ready(function() {
    ...
    $checkInDatePicker.on('pick.datepicker', function() {
        ...
        //Hide check-in datepicker after selection
        $checkInDatePicker.datepicker('hide');
    });


    $checkOutDatePicker.on('pick.datepicker', function() {
        updateStayLength();

        // Hide the check-out datepicker after selection
